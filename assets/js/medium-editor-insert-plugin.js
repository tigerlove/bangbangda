...
;(function ($, window, document, undefined) {
    ...
    Embeds.prototype.parseUrl = function (url) {
        ...
        if (!(new RegExp(['youtube', 'youtu.be', 'vimeo','youku', 'instagram'].join('|')).test(url))) {
        ...
        html = url.replace(/\n?/g, '')
            ...
            .replace(/^http?:\/\/v\.youku\.com\/v_show\/(id_?)([a-zA-Z0-9]+)(.*)?$/,'<iframe height=498 width=510 src="http://player.youku.com/embed/$2" frameborder=0 allowfullscreen></iframe>')
